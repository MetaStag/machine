    ...
    let msgs = [
      {
        role: "system",
        content: `
      You are a crypto currency expert that analyzes this text containing information about the time stamp of coin, price, volume, mean price, price standard deviation, price_change, volume change, rolling mean of 5 days, rolling mean of 20 days, rolling standard deviation of 5 days, relative strength index, whether the data is anomalous  price change percentage, rolling standard deviation and if the data is an anomaly in boolean((ignore this)
